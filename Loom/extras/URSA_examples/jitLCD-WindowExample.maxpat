...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 19.0, 150.0, 75.0 ],
					"text" : "This is a cool way to put your drawings in a window outside max--could be used for making stuff full screen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 74.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 437.0, 150.0, 48.0 ],
					"text" : "Check out the jit.lcd help file for a more comprehensive example"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 541.0, 150.0, 34.0 ],
					"text" : "gives last mouse click coords and other info"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 443.0, 150.0, 34.0 ],
					"text" : "seems to bang every update"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 98.0, 489.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 526.0, 50.0, 64.0 ],
					"text" : "mouse 292 131 0 0 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 250.0, 150.0, 158.0 ],
					"text" : "Not sure what the first two args are but 320 & 420 are the window size. To use full screen I would suggest finding what your screen size is then enter it for these args. If you hit full screen as is, the offsets will be off when drawing with the mouse in this example."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 122.0, 182.0, 34.0 ],
					"text" : "This is stuff I stole from the jit.lcd help file. Pretty self explanatory"
				}
