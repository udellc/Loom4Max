...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ -368.0, 1665.0, 40.0, 22.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -259.999999999999773, 1783.0, 40.0, 22.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -197.999999999999773, 1754.5, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -418.499999999999773, 1786.5, 152.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -259.999999999999773, 1697.5, 32.0, 22.0 ],
					"text" : "$1 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ -259.999999999999773, 1725.5, 40.0, 22.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -259.999999999999773, 1837.0, 123.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ -259.999999999999773, 1882.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -259.999999999999773, 1754.5, 52.0, 22.0 ],
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -231.0, 1141.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ -424.0, 1243.0, 40.0, 22.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -432.0, 1280.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -249.999999999999773, 1204.5, 62.0, 22.0 ],
					"text" : "route max"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -316.499999999999773, 1204.5, 59.0, 22.0 ],
					"text" : "route min"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -221.0, 1262.0, 229.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -316.499999999999773, 1234.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -249.999999999999773, 1234.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -100.0, 1394.0, 238.0, 40.0 ],
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ -334.0, 1605.0, 59.0, 22.0 ],
					"text" : "noteout 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -334.0, 1542.0, 204.0, 22.0 ],
					"text" : "makenote 60 10000 @repeatmode 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ -334.0, 1322.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -277.0, 1312.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -334.0, 1271.0, 107.0, 22.0 ],
...
,
					"patching_rect" : [ -334.0, 1373.0, 238.0, 149.0 ],
					"varname" : "patch_3[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "SensorTable.maxpat",
					"numinlets" : 1,
					"numoutlets" : 5,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ -459.419353842735291, 667.0, 438.419353842735291, 458.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1053.0, 872.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1040.0, 784.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1031.0, 812.0, 167.0, 22.0 ],
					"text" : "if $f1 > 10000. then 0 else $f1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.5, 796.0, 160.0, 22.0 ],
					"text" : "if $f1 > 1500. then 0 else $f1"
				}
...
, 							{
								"box" : 								{
									"id" : "obj-2",
									"items" : [ "Packet", ",", "Analog", ",", "SHT31", ",", "TSL2591", ",", "GS3_0", ",", "MS5803", ",", "WiFi", ",", "Timestamp" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 1143.0, 1867.5, 204.0, 22.0 ],
					"text" : "makenote 60 10000 @repeatmode 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1370.0, 549.0, 325.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"range" : 3193,
					"size" : 48,
					"table_data" : [ 0, 31, 3130, 3128, 3125, 3164, 3165, 3172, 3173, 3173, 3173, 3173, 3173, 3173, 3175, 3173, 3173, 3173, 3175, 3175, 3173, 3173, 3175, 3175, 3173, 3173, 3173, 3173, 3173, 3171, 3170, 3170, 3170, 3171, 3172, 3175, 3176, 3177, 3179, 3180, 3184, 3186, 3187, 3188, 3190, 3193, 3193, 2912, 2912 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 519.0, 863.0, 165.0, 22.0 ],
					"text" : "7223 4.273242"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 830.0, 57.0, 22.0 ],
					"text" : "pack 1 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 857.0, 163.0, 130.0, 37.0 ],
					"text" : "Get last N samples Up to 4096"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.5, 830.0, 122.0, 24.0 ],
