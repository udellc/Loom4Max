...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 301.0, 450.0, 55.0, 49.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"id" : "obj-30",
									"items" : [ "OontZAngle3DSE00-JL_SPP", ",", "Bluetooth-Incoming-Port", ",", "BoseS1Pro-SPPDev", ",", "ChetsBeats-SPPServer" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"text" : "port ChetsBeats-SPPServer"
												}
