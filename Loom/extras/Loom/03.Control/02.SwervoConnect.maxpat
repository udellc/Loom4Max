...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 334.5, 221.0, 167.0 ],
					"text" : "Still having Trouble?\nEnsure your firewall is dissabled for the Max 8 application.\n\nWindows: https://www.computerhope.com/issues/ch001324.htm\n\nMac:\nhttps://support.apple.com/en-us/HT201642\nLook for \"Allowing Specific Applications\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 158.0, 220.0, 167.0 ],
					"text" : "Having trouble connecting?\nTry power-cycling your WiFi devices:\n1) turn off computer WiFi\n2) turn off Loom devices\n3) wait a second\n4) Turn on Loom device\n5) Trun on computer WiFi\n6) For computer WiFi, Choose the Loom device you wish to connect.\n7) double check the number on Step 1 matches the number on your device name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 625.5, 14.0, 237.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 599.5, 14.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 599.5, 45.0, 63.0, 22.0 ],
					"text" : "metro 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 730.5, 114.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 739.5, 149.0, 176.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 735.5, 179.5, 226.0, 24.0 ],
...
,
					"patching_rect" : [ 599.5, 144.0, 150.0, 95.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 625.5, 78.0, 124.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 599.5, 78.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.5, 114.0, 176.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 617.0, 371.0, 150.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 880.5, 391.0, 257.0, 78.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 215.0, 270.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 982.0, 261.0, 150.0, 78.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 221.833344000000011, 428.0, 204.0, 35.0 ],
									"text" : "MaxSub c Kalani UdellFamilyWireless"
								}
...
, 							{
								"box" : 								{
									...
									"border" : 3,
									"bordercolor" : [ 0.376, 0.384, 0.4, 1.0 ],
									"id" : "obj-20",
									"maxclass" : "panel",
									"mode" : 0,
									"numinlets" : 1,
...
,
					"patching_rect" : [ 827.5, 215.0, 150.0, 170.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 641.0, 520.0, 350.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 276.0, 150.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 334.5, 270.0, 51.0 ],
...
,
					"patching_rect" : [ 499.0, 342.0, 220.0, 36.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									"id" : "obj-15",
									"items" : [ "Servo0", ",", "Servo1", ",", "Servo2", ",", "Servo3", ",", "Servo4", ",", "Servo5", ",", "Servo6", ",", "Servo7" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 497.0, 488.0, 150.0, 126.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.5, 82.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "7",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 352.0, 193.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "0",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 659.0, 495.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "6",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.0, 420.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 799.0, 219.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 246.0, 310.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 837.0, 395.0, 779.0, 395.0, 779.0, 331.0, 609.0, 331.0 ],
					"source" : [ "obj-3", 0 ]
				}
