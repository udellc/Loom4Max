...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 292.0, 193.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 230.0, 279.0, 49.0 ],
					"presentation_linecount" : 4,
					"text" : ";\rmax launchbrowser https://www.youtube.com/watch?v=fOwb0inoAWc"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 665.0, 873.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 665.0, 906.0, 69.0, 22.0 ],
					"text" : "metro 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 979.0, 150.0, 64.0 ],
					"text" : "Then click in the box with patch locked to see letters typed in the box"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 81.0, 658.0, 150.0, 33.0 ],
					"text" : "Click Toggle to type \"a\" key every 2 sec"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 116.75, 699.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 116.75, 732.0, 69.0, 22.0 ],
					"text" : "metro 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.5, 162.0, 220.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 193.0, 271.0, 35.0 ],
					"text" : ";\rmax launchbrowser https://youtu.be/IDVHkcUB9jI"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 1100.0, 302.0, 37.0 ],
					"text" : "You will need to use m key as the safety for enabling mouse movement"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 252.0, 769.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 263.333333333333371, 979.0, 121.666666666666629, 65.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.0, 796.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 826.0, 345.0, 24.0 ],
					"text" : "Letters followed by 2 will \"type\" e.g. press and unpress"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 827.0, 29.5, 22.0 ],
					"text" : "a 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 665.0, 940.0, 310.0, 24.0 ],
					"text" : "seperating button sequences by a comma is useful"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 551.0, 902.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 551.0, 940.0, 107.0, 22.0 ],
					"text" : "Shift 1, a 2, Shift 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 685.0, 1039.0, 290.0, 24.0 ],
					"text" : "See this menu for available key strokes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 775.0, 290.0, 24.0 ],
					"text" : "Letters followed by 1 for press or 0 for unpress"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 754.0, 569.5, 365.0, 51.0 ],
					"text" : "MX and MY messages controll the mouse X and Y axes.\nA range of -1.0 to 1.0 corresponds to how fast the cursor is moved in the left/up or right/down direction"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 928.0, 302.0, 24.0 ],
					"text" : "Click Toggle to enable data to pass to Switchblade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 775.0, 32.0, 22.0 ],
					"text" : "a $1"
				}
...
,
					"patching_rect" : [ 305.0, 617.0, 105.0, 145.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.5, 928.0, 24.0, 24.0 ]
				}
...
, 							{
								"box" : 								{
									"id" : "obj-15",
									"items" : [ "ax", ",", "ay", ",", "az", ",", "gx", ",", "gy", ",", "gz", ",", "roll", ",", "pitch", ",", "yaw" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									"id" : "obj-2",
									"items" : [ "Packet", ",", "Analog", ",", "Digital", ",", "MPU6050" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 698.0, 418.0, 150.0, 126.0 ],
					"varname" : "patch_0[2]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 531.0, 418.0, 150.0, 126.0 ],
					"varname" : "patch_0[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "Switchblade.maxpat",
					"numinlets" : 1,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 462.5, 1035.0, 245.0, 160.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.5, 983.0, 34.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 698.0, 584.0, 45.0, 22.0 ],
					"text" : "MY $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 531.0, 584.0, 45.0, 22.0 ],
					"text" : "MX $1"
				}
...
,
					"patching_rect" : [ 456.5, 143.0, 150.0, 170.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 128.0, 429.0, 150.0, 182.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 429.0, 151.0, 47.0 ],
...
,
					"patching_rect" : [ 128.0, 301.0, 220.0, 36.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 305.0, 480.0, 150.0, 126.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 81.0, 699.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 121.0, 928.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 121.0, 1100.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 262.5, 162.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 466.0, 323.0, 408.0, 323.0, 408.0, 293.0, 238.0, 293.0 ],
					"source" : [ "obj-3", 0 ]
				}
