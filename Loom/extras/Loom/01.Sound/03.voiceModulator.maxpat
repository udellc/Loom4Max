...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.166666666666629, 953.0, 478.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.5, 856.0, 50.0, 22.0 ],
					"text" : "1 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 282.5, 815.0, 166.0, 22.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, "MRingModulator.vst3info", ";" ],
...
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"pluginname" : "MRingModulator.vst3info",
							"plugindisplayname" : "MRingModulator",
							"pluginsavedname" : "",
							"pluginsaveduniqueid" : 1049925478,
							"version" : 1,
							"isbank" : 0,
							"isbase64" : 1,
							"blob" : "846.VMjLgTz....OVMEUy..."
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "MRingModulator",
									"origin" : "MRingModulator.vst3info",
									"type" : "VST3",
									"subtype" : "MidiEffect",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "MRingModulator",
										"filename" : "MRingModulator.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "1cd1aca14275d21b78319e470712df61"
									}
...
,
					"text" : "vst~ MRingModulator.vst3info",
					"varname" : "vst~",
					"viewvisibility" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.0, 687.0, 150.0, 60.0 ],
					"text" : "We are going to make control streams to modulate the voice changer parameters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.5, 815.0, 198.0, 24.0 ],
					"text" : "double-click to open VST effect"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 405.0, 150.0, 20.0 ],
					"text" : "Set input source (1 first)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.666666666666629, 856.0, 360.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 427.166666666666629, 856.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.166666666666629, 894.0, 287.0, 49.0 ],
					"text" : ";\rmax launchbrowser https://www.meldaproduction.com/MFreeFxBundle"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.666666666666629, 806.0, 296.5, 40.0 ],
					"text" : "Free VST. If this does not load, Go to the plug icon in left toolbar and search for MCharacter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 451.5, 567.0, 241.5, 40.0 ],
					"text" : "A number in the left inlet of selector~ sets the corresponding audio source"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 498.0, 241.5, 40.0 ],
					"text" : "Have headphones plugged in before selecting your microphone input!"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 427.166666666666629, 492.0, 45.0, 45.0 ]
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 354.833333333333314, 405.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 498.0, 152.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 469.0, 130.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 440.0, 114.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 283.0, 440.0, 19.0, 89.0 ],
					"size" : 3,
					"value" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 282.5, 576.0, 163.666666666666629, 22.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.5, 947.0, 259.0, 24.0 ],
					"text" : "click-drag to turn up volume on both sliders"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 265.0, 270.5, 49.0 ],
					"text" : ";\rmax launchbrowser https://www.youtube.com/watch?v=ln-Jq6X6p-g"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 282.5, 928.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 1088.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.0, 923.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "6",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 358.0, 373.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.0, 405.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.0, 793.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "5",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
