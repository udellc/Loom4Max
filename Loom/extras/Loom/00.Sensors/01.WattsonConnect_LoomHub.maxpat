...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 247.0, 60.0, 20.0 ],
					"text" : "Optional"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 744.0, 15.0, 60.0, 20.0 ],
					"text" : "Optional"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 506.0, 221.0, 167.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 158.0, 220.0, 342.0 ],
					"text" : "Having trouble connecting?\n\nPress (mac)Command+m (pc) Alt+m\nLook for red error messages. Ones mentioning JVM or Java indicates you still need to install Java AND Java Vurtual Machine befroe starting Max\n\nErrors mentioning missing objects and deleting patch cords may indicate having the Optron folder in the wrong place on your computer; review instructions.\n\nTry power-cycling your WiFi devices:\n1) turn off computer WiFi\n2) turn off Loom devices\n3) wait a second\n4) Turn on Loom device\n5) Trun on computer WiFi\n6) For computer WiFi, Choose the Loom device you wish to connect.\n7) double check the number on Step 1 matches the number on your device name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 870.5, 213.0, 257.0, 91.0 ],
					"text" : "If you change routers: Connect your Computer WiFi to the same router you set the Wattson. You should see the blue connection light blink again. Now your computer and Wattson are on the same network."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 26.0, 270.0, 119.0 ],
					"text" : "First, connect your computer WiFi to the included WiFi router (or your own router with the LoomHub# SSID and password), where the # is the Instance Number label on your Wattson device. If there is no number at the end of the LoomHub WiFi name, join it and use the provided password."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 762.0, 665.0, 414.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 963.0, 63.0, 150.0, 118.0 ],
					"text" : "If you wish to change routers (not recommended for class) Click Client button, Type in SSID (router name) and Password in the fields. Click the send button"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.0, 350.0, 215.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 828.0, 536.0, 400.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 681.0, 506.0, 400.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 270.0, 178.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 666.0, 665.0, 90.0, 21.0 ]
				}
...
,
					"patching_rect" : [ 666.0, 536.0, 160.0, 115.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 92.0, 150.0, 79.0 ],
					"text" : "The name of the device (Wattson) will appear here when connected and blue connection light will blink"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 342.0, 6.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "0",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 637.0, 540.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "7",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 846.0, 247.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 796.0, 15.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.0, 151.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
