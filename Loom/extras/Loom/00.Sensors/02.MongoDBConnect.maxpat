...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 542.0, 15.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1008.0, 23.0, 24.0, 24.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 280.833344000000011, 272.0, 62.0, 45.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 1025.0, 55.0, 372.0, 282.0 ],
					"varname" : "patch_4[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 865.0, 175.0, 150.0, 20.0 ],
					"text" : "helloworld101"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 865.0, 266.0, 150.0, 20.0 ],
					"text" : "Chime2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 865.0, 241.0, 150.0, 20.0 ],
					"text" : "WeatherChimes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 865.0, 200.0, 150.0, 20.0 ],
					"text" : "remotetest.cls7o"
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"patching_rect" : [ 485.000000000000114, 537.0, 203.0, 49.0 ],
									"text" : "grab HC407 helloworld101 remotetest.cls7o WeatherChimes Chime2"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 324.453605532646179, 620.0, 400.0, 220.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"patching_rect" : [ 244.833344000000011, 427.0, 203.0, 49.0 ],
									"text" : "connect HC407 helloworld101 remotetest.cls7o WeatherChimes Chime2"
								}
...
,
					"patching_rect" : [ 489.0, 51.0, 372.0, 282.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1226.0, 756.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1226.0, 724.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
,
					"patching_rect" : [ 1075.0, 562.0, 105.0, 145.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 561.0, 629.0, 73.0, 22.0 ],
					"text" : "print Sensor"
				}
...
,
					"patching_rect" : [ 296.0, 462.0, 150.0, 330.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 37.0, 270.0, 66.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 2.975098000000003, 556.0, 85.524901999999997, 22.0 ],
									"text" : "20:38:52",
									"varname" : "param_view"
								}
...
, 							{
								"box" : 								{
									"id" : "obj-2",
									"items" : [ "Timestamp", ",", "GS3", ",", "Packet", ",", "SHT31D", ",", "TSL2591" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 687.0, 364.0, 150.0, 126.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 828.0, 401.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "6",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
