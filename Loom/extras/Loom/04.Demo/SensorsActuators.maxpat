...
, 							{
								"box" : 								{
									"id" : "obj-2",
									"items" : [ "Packet", ",", "WiFi", ",", "MPU6050", ",", "Analog", ",", "Digital" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 1929.0, 434.5, 150.0, 126.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1673.0, 890.5, 164.0, 24.0 ],
					"text" : "Click to toggle relay on/off"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1823.5, 768.0, 176.0, 24.0 ],
					"text" : "bang to send state manually"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1797.5, 768.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1955.0, 797.0, 176.0, 24.0 ],
					"text" : "Set state on (1) or off (0)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1929.0, 797.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1943.0, 844.0, 148.0, 24.0 ],
					"text" : "Click to send manually"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1943.0, 884.0, 350.0, 37.0 ],
					"presentation_linecount" : 2,
					"text" : "Green is enabled: send relay state change messade automatically"
				}
...
,
					"patching_rect" : [ 1797.5, 844.0, 150.0, 85.0 ],
					"varname" : "patch_3[3]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1815.0, 1129.0, 148.0, 66.0 ],
					"presentation_linecount" : 3,
					"text" : "hint: try clicking this button if it has trouble connecting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1839.0, 1278.0, 350.0, 64.0 ],
					"presentation_linecount" : 4,
					"text" : "Relay Status in hardware is reported back to Max using the connected sensor module; may come in handy or may not.\nSelect Relay in top menu. On in bottom menu reports 1 or 0 if on or off."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1707.0, 1028.0, 150.0, 79.0 ],
					"presentation_linecount" : 4,
...
,
					"patching_rect" : [ 1697.0, 1100.0, 220.0, 36.0 ],
					"varname" : "patch_1[3]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 1695.0, 1246.0, 150.0, 126.0 ],
					"varname" : "patch_0[3]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 304.0, 216.0, 51.0 ],
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1113.0, 490.0, 400.0, 37.0 ],
					"presentation_linecount" : 2,
					"text" : "There are many different modules to transform your data into useful control streams!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 966.0, 460.0, 400.0, 24.0 ],
					"text" : "Data comes out of this outlet to be used in other objects and modules"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1035.0, 389.0, 350.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 603.0, 224.0, 162.0, 51.0 ],
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 796.0, 46.0, 150.0, 79.0 ],
					"presentation_linecount" : 4,
					"text" : "The name of the device will appear here when connected and blue connection light will blink"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 109.5, 270.0, 51.0 ],
					"presentation_linecount" : 3,
...
,
					"patching_rect" : [ 951.0, 656.0, 175.0, 130.0 ],
					"varname" : "patch_7",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 1929.0, 572.0, 105.0, 145.0 ],
					"varname" : "patch_6",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 951.0, 822.0, 81.0, 22.0 ],
					"text" : "send servPos"
				}
...
,
					"patching_rect" : [ 581.0, 415.0, 150.0, 330.0 ],
					"varname" : "patch_5",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 951.0, 489.0, 160.0, 115.0 ],
					"varname" : "patch_3[2]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 774.0, 276.0, 150.0, 182.0 ],
					"varname" : "patch_2[1]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 774.0, 117.0, 220.0, 36.0 ],
					"varname" : "patch_1[2]",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 301.666655999999989, 122.0, 70.0, 22.0 ],
									"saved_object_attributes" : 									{
										"filename" : "Sensor.js",
										"parameter_enable" : 0
									}
...
,
					"patching_rect" : [ 951.0, 327.0, 150.0, 126.0 ],
					"varname" : "patch_0[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 780.0, 94.0, 22.0 ],
					"text" : "receive servPos"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.5, 725.0, 237.0, 24.0 ],
					"text" : "or click to enable 300ms refresh period"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 128.5, 725.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 128.5, 756.0, 63.0, 22.0 ],
					"text" : "metro 300"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.5, 825.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.5, 860.0, 176.0, 24.0 ],
					"text" : "Click to send below position"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.5, 890.5, 226.0, 24.0 ],
					"text" : "Click-hold-drag to set Servo Position"
				}
...
,
					"patching_rect" : [ 128.5, 855.0, 150.0, 95.0 ],
					"varname" : "patch_3[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.5, 789.0, 124.0, 24.0 ],
					"text" : "click bang to send"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 128.5, 789.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.5, 825.0, 176.0, 24.0 ],
					"text" : "Set servo position 0 - 156"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 1082.0, 148.0, 66.0 ],
					"presentation_linecount" : 3,
					"text" : "hint: try clicking this button if it has trouble connecting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 1231.0, 350.0, 64.0 ],
					"presentation_linecount" : 4,
					"text" : "Servo Status in hardware is reported back to Max using the connected sensor module; may come in handy or may not.\nSelect Servo in top menu. On in bottom menu, select the target number servo you wish to monitor."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 987.0, 150.0, 79.0 ],
					"presentation_linecount" : 4,
					"text" : "The name of the device will appear here when connected and blue connection light will blink"
				}
...
,
					"patching_rect" : [ 28.0, 1053.0, 220.0, 36.0 ],
					"varname" : "patch_1[1]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 26.0, 1199.0, 150.0, 126.0 ],
					"varname" : "patch_0[1]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 11.0, 4.0, 195.0, 130.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1278.5, 916.0, 125.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1278.5, 894.0, 82.0, 24.0 ],
					"text" : "Clockwise"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1258.0, 895.0, 18.0, 34.0 ],
					"size" : 2,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1111.799999999999955, 886.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1162.799999999999955, 886.0, 65.0, 24.0 ],
					"text" : "Speed"
				}
...
,
					"patching_rect" : [ 1007.0, 922.0, 150.0, 165.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1086.0, 855.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1190.5, 989.0, 176.0, 24.0 ],
					"text" : "Click to send below position"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1186.5, 1019.5, 226.0, 24.0 ],
					"text" : "Click-hold-drag to set Servo Position"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1033.0, 829.0, 124.0, 24.0 ],
					"text" : "click bang to send"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1007.0, 829.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1137.0, 855.0, 133.0, 24.0 ],
					"text" : "num steps to travel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1068.0, 1211.0, 148.0, 66.0 ],
					"text" : "hint: try clicking this button if it has trouble connecting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1331.5, 1231.0, 257.0, 78.0 ],
					"text" : "Connect your Computer WiFi to the same router you set the Clickey. You should see the blue connection light blink again. Now your computer and Relay Kit are on the same network."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.0, 1055.0, 273.0, 66.0 ],
					"text" : "First, connect your computer WiFi to Swervo#, where the # is the Instance Number label on your Loom Relay kit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1433.0, 1101.0, 134.0, 78.0 ],
...
,
					"patching_rect" : [ 1278.5, 1055.0, 150.0, 170.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1092.0, 1360.0, 215.0, 24.0 ],
					"text" : "Stepper only reports packets sent"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 974.0, 1116.0, 150.0, 79.0 ],
					"text" : "The name of the device will appear here when connected and blue connection light will blink"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 688.0, 1174.5, 270.0, 51.0 ],
					"text" : "Set this to the Instance Number of the device you wish to connect. Click-hold-drag, or click then type the number then pres return"
				}
...
,
					"patching_rect" : [ 950.0, 1182.0, 220.0, 36.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 948.0, 1328.0, 150.0, 126.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1772.0, 816.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "7",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1857.0, 1253.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "6",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 1288.0, 1235.0, 1230.0, 1235.0, 1230.0, 1171.0, 1060.0, 1171.0 ],
					"source" : [ "obj-3", 0 ]
				}
